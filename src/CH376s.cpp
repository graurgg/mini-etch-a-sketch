...
void CH376s::public_setFileName(String fileName) {
  setFileName(fileName);
}

void CH376s::public_tryOpen() {
  tryOpen();
}

byte CH376s::public_getResponseFromUSB() {
  return getResponseFromUSB();
}

		
void CH376s::public_begin(long speed) {
  begin(speed);
}
